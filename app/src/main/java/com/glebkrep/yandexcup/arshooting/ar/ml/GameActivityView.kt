...
import com.glebkrep.yandexcup.arshooting.ar.common.helpers.SnackbarHelper
import com.glebkrep.yandexcup.arshooting.ar.common.samplerender.SampleRender

/**
 * Wraps [R.layout.activity_game] and controls lifecycle operations for [GLSurfaceView].
 */
class GameActivityView(val activity: GameActivity, renderer: AppRenderer) : DefaultLifecycleObserver {
  val root = View.inflate(activity, R.layout.activity_game, null)
