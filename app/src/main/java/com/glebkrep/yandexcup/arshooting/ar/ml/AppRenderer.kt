 ...
 */
package com.glebkrep.yandexcup.arshooting.ar.ml

import android.opengl.Matrix
import android.util.Log
import androidx.lifecycle.DefaultLifecycleObserver
import androidx.lifecycle.LifecycleOwner
import com.glebkrep.yandexcup.arshooting.GameActivity
import com.google.ar.core.Anchor
import com.google.ar.core.Coordinates2d
import com.google.ar.core.Frame
import com.google.ar.core.TrackingState
import com.glebkrep.yandexcup.arshooting.ar.common.helpers.DisplayRotationHelper
import com.glebkrep.yandexcup.arshooting.ar.common.samplerender.SampleRender
import com.glebkrep.yandexcup.arshooting.ar.common.samplerender.arcore.BackgroundRenderer
import com.glebkrep.yandexcup.arshooting.ar.ml.classification.DetectedObjectResult
import com.glebkrep.yandexcup.arshooting.ar.ml.classification.GoogleCloudVisionDetector
import com.glebkrep.yandexcup.arshooting.ar.ml.classification.MLKitObjectDetector
import com.glebkrep.yandexcup.arshooting.ar.ml.classification.ObjectDetector
import com.glebkrep.yandexcup.arshooting.ar.ml.render.LabelRender
import com.glebkrep.yandexcup.arshooting.ar.ml.render.PointCloudRender
 ...
 */
class AppRenderer(val activity: GameActivity) : DefaultLifecycleObserver, SampleRender.Renderer, CoroutineScope by MainScope() {
  companion object {
    val TAG = "HelloArRenderer"
  }

  lateinit var view: GameActivityView
  ...
  fun bindView(view: GameActivityView) {
    this.view = view
